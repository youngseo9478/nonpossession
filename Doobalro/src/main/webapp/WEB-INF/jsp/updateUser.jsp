          ...
          <div class="card col-lg-4 mx-auto">
            <div class="card-body px-5 py-5">
              <h3 class="card-title text-left mb-3">회원정보</h3>
								...
								<input id=userPw type="hidden" value="${user.userPw}">
							
								
                <div class="form-group">
                  <label>이름</label>
                  <input type="text" id="userName" class="form-control p_input" value="${user.userName}">
                </div>
                
                   <div class="form-group">
                  <label>핸드폰번호</label>
                  <input type="text" id="userPhone" class="form-control p_input" value="${user.userPhone}">
                </div>                
                	<div class="form-group">
                	<label>생일</label>
