								...
								<div class="content">
									<form action="addBoard.do" method="post">
											...
											<div class="col-md-12">
												<div class="form-group">
													<label>제목</label> <input type="text"
														class="form-control border-input" placeholder="제목을 입력하세요"
														value="" name="boardTitle">
												</div>
											</div>
										</div>
										<div class="row">
										...
										<div class="text-center">
											<a type="button" href="./listBoard.do" class="btn btn-info btn-fill btn-wd" >뒤로</a>
											<button type="submit" class="btn btn-info btn-fill btn-wd">완료</button>
										</div>
